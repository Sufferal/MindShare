...
const jsonData = [
  ...
  mollit anim id est laborum.' , comments: [{author: 'Dinu', creationDate: new Date().toDateString(), content: 'hello'}, {author: 'Dinu', creationDate: new Date().toDateString(), content: 'hello'}]},
